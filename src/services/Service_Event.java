...
public class Service_Event {
    ...
    public boolean addEvent(Events e) {
        String url = Statics.BASE8_URL + "/events/" + e.getEventname() + "/" + e.getEventtheme_id(); //création de l'URL
        ...
        try {
            ...
            */
            ...
            for(Map<String,Object> obj : list){
                ...
                e.setEventname(obj.get("eventname").toString());
